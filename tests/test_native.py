from mechanica import native_spring_available, native_spring_status
from mechanica import _native


def test_native_spring_status_reports_loader_failure(monkeypatch) -> None:
    def fail_load():
...
def test_native_spring_status_reports_loader_success(monkeypatch) -> None:
